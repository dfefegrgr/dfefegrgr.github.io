...
*/
        ...
        var a = n(42), u = r(a), s = n(33), l = r(s), c = n(37), f = r(c), p = n(12), d = r(p), h = n(6), v = n(41),
            ...
            B = {}, $ = {
                cdn: "https://th.bing.com/th/id/OIP.eTKjPZV14b1NBppQmF9fJQHaGj?rs=1&pid=ImgDetMain",
        ...
        i.prototype.Q = function (e) {
            ...
            var j = function () {
                ...
                var s = t.get("link") ? /^https?\:\/\//.test(t.get("link")) ? t.get("link") : "http://" + t.get("link") : "",
                    ...
                    c = s ? '<a class="vnick"  rel="nofollow" href="' + j(s) + '" target="_blank" >' + l + "</a>" : '<span class="vnick" style="color: #0f7e68">' + l + "</span>",
                    ...
                    // p = f + '<div class="vh"><div class="vhead">' + c + " " + a + '</div><div class="vmeta"><span class="vtime" >' + (0, g.default)(t.get("insertedAt"), e.i18n) + '</span><span class="vat" data-vm-id="' + (t.get("rid") || t.id) + '" data-self-id="' + t.id + '">' + e.i18n.t("reply") + '</span></div><div class="vcontent" data-expand="' + e.i18n.t("expand") + '">' + (0, E.default)(t.get("comment")) + '</div><div class="vreply-wrapper" data-self-id="' + t.id + '"></div><div class="vquote" data-self-id="' + t.id + '"></div></div>';
                     p = f + '<div class="vh" ><div class="vhead" style="background-color: rgba(246,229,229,0.53);padding-left: 2px;padding-right: 5px;">' + c + " "  + '<span style="font-size: 12px;color: gray">' + (0, g.default)(t.get("insertedAt"), e.i18n) +'</span>' + '<span class="vtime" >' + '</span><span class="vat" style="font-size:.8125em;color:#e23084;cursor:pointer;float:right" data-vm-id="' + (t.get("rid") || t.id) + '" data-self-id="' + t.id + '">' + e.i18n.t("reply") + '</span></div><div class="vcontent" data-expand="' + e.i18n.t("expand") + '">' + (0, E.default)(t.get("comment")) + '</div><div class="vreply-wrapper" data-self-id="' + t.id + '"></div><div class="vquote" data-self-id="' + t.id + '"></div></div>';
                i.html(p);
                var d = i.find(".vat");
...
*/
        ...
        t = n(105)(!1), t.push([e.i, '.v[data-class=v]{font-size:16px;text-align:left}' +
        '.v[data-class=v] *{-webkit-box-sizing:border-box;box-sizing:border-box;line-height:18px}' +
        '.v[data-class=v] .vinput,.v[data-class=v] .veditor,.v[data-class=v] p,.v[data-class=v] pre code,.v[data-class=v] .status-bar{' +
        'color:#555' +
        // 'color:pink' +
        '}' +
        '.v[data-class=v] .vtime,.v[data-class=v] .vsys{color:#b3b3b3}' +
        '.v[data-class=v] .text-right{text-align:right}' +
        '.v[data-class=v] .text-center{text-align:center}' +
        '.v[data-class=v] img{max-width:100%;border:none}' +
        '.v[data-class=v] hr{margin:.825em 0;border-color:#f6f6f6;border-style:dashed}' +
        '.v[data-class=v].hide-avatar .vimg{display:none}' +
        '.v[data-class=v] a{position:relative;cursor:pointer;color:#1abc9c;text-decoration:none;display:inline-block}' +
        '.v[data-class=v] a:hover{color:#d7191a}' +
        '.v[data-class=v] pre,.v[data-class=v] code{' +
        ...
        '' +
        '.v[data-class=v] pre{padding:10px;overflow:auto;line-height:1.45}' +
        '.v[data-class=v] pre code{padding:0;background:transparent;white-space:pre-wrap;word-break:keep-all}' +
        '.v[data-class=v] blockquote{color:#666;margin:.5em 0;padding:0 0 0 1em;border-left:8px solid rgba(238,238,238,.5)}' +
        '' +
        ...
        // 'padding:10px 5px;' +
        'max-width:100%;' +
        'font-size:.775em;-webkit-box-sizing:border-box;box-sizing:border-box}' +
        '.v[data-class=v] input[type=checkbox],.v[data-class=v] input[type=radio]{display:inline-block;vertical-align:middle;margin-top:-2px}' +
        '.v[data-class=v] .vicon{cursor:pointer;display:inline-block;overflow:hidden;fill:#555;vertical-align:middle}' +
        '.v[data-class=v] .vicon+.vicon{margin-left:10px}.v[data-class=v] .vicon.actived{fill:#66b1ff}' +
        '' +
        '.v[data-class=v] .vrow{' +
        'font-size:0;' +
        // 'padding:10px 0' +
        '}' +
        '.v[data-class=v] .vrow .vcol{display:inline-block;vertical-align:middle;font-size:14px}' +
        '.v[data-class=v] .vrow .vcol.vcol-20{width:20%}' +
        '.v[data-class=v] .vrow .vcol.vcol-30{width:30%}' +
        '.v[data-class=v] .vrow .vcol.vcol-40{width:40%}' +
        '.v[data-class=v] .vrow .vcol.vcol-50{width:50%}' +
        '.v[data-class=v] .vrow .vcol.vcol-60{width:60%}' +
        '.v[data-class=v] .vrow .vcol.vcol-70{width:70%}' +
        '.v[data-class=v] .vrow .vcol.vcol-80{width:80%}' +
        '.v[data-class=v] .vrow .vcol.vctrl{font-size:12px}' +
        '.v[data-class=v] .vemoji,.v[data-class=v] .emoji{width:26px;height:26px;overflow:hidden;vertical-align:middle;margin:0 1px;display:inline-block}' +
        '.v[data-class=v] .vwrap{border:1px solid #f0f0f0;border-radius:4px;margin-bottom:10px;overflow:hidden;position:relative;padding:10px}' +
        // '.v[data-class=v] .vwrap{border:1px solid #f0f0f0;border-radius:4px;margin-bottom:10px;overflow:hidden;position:relative;padding:10px}' +
        '.v[data-class=v] .vwrap input{background:transparent}' +
        '.v[data-class=v] .vwrap .vedit{position:relative;padding-top:5px}' +
        '.v[data-class=v] .vwrap .cancel-reply-btn{position:absolute;right:5px;top:5px;cursor:pointer}' +
        '.v[data-class=v] .vwrap .vemojis' +
        '{display:none;font-size:18px;' +
        'max-height:50px;' +
        // 'max-height:145px;' +
        'overflow:auto;padding-bottom:10px;-webkit-box-shadow:0px 0 1px #f0f0f0;box-shadow:0px 0 1px #f0f0f0}' +
        '.v[data-class=v] .vwrap .vemojis i{font-style:normal;padding-top:7px;width:36px;cursor:pointer;text-align:center;display:inline-block;vertical-align:middle}.v[data-class=v] .vwrap .vpreview{padding:7px;-webkit-box-shadow:0px 0 1px #f0f0f0;box-shadow:0px 0 1px #f0f0f0}' +
        '.v[data-class=v] .vwrap .vheader .vinput{width:33.33%;border-bottom:1px #dedede dashed}' +
        '.v[data-class=v] .vwrap .vheader.item2 .vinput{width:50%}' +
        '.v[data-class=v] .vwrap .vheader.item1 .vinput{width:100%}' +
        '.v[data-class=v] .vwrap .vheader .vinput:focus{border-bottom-color:#eb5055}' +
        '@media screen and (max-width: 520px){' +
        '.v[data-class=v] .vwrap .vheader .vinput{width:100%}' +
        '.v[data-class=v] .vwrap .vheader.item2 .vinput{width:100%}}' +
        '.v[data-class=v] .vpower{color:#999;font-size:.75em;padding:.5em 0}' +
        '.v[data-class=v] .vpower a{font-size:.75em}' +
        '.v[data-class=v] .vcount{padding:5px;font-weight:600;font-size:1.25em}' +
        '.v[data-class=v] ul,.v[data-class=v] ol{padding:0;margin-left:1.25em}' +
        '.v[data-class=v] .txt-center{text-align:center}.v[data-class=v] .txt-right{text-align:right}' +
        ...
        '.v[data-class=v] .vbtn{-webkit-transition-duration:.4s;transition-duration:.4s;text-align:center;color:#555;border:1px solid #ededed;border-radius:.3em;display:inline-block;background:transparent;margin-bottom:0;font-weight:400;vertical-align:middle;-ms-touch-action:manipulation;touch-action:manipulation;cursor:pointer;white-space:nowrap;padding:.5em 1.25em;font-size:.875em;line-height:1.42857143;-webkit-user-select:none;-moz-user-select:none;-ms-user-select:none;user-select:none;outline:none}.v[data-class=v] .vbtn+.vbtn{margin-left:1.25em}' +
        '.v[data-class=v] .vbtn:active,.v[data-class=v] .vbtn:hover{color:#3090e4;border-color:#3090e4}' +
        '.v[data-class=v] .vbtn:disabled{border-color:#e1e1e1;color:#e1e1e1;background-color:#fdfafa;cursor:not-allowed}' +
        '.v[data-class=v] .vempty{padding:1.25em;text-align:center;color:#555;overflow:auto}' +
        '.v[data-class=v] .vsys{display:inline-block;padding:.2em .5em;font-size:.75em;border-radius:.2em;margin-right:.3em}' +
        '@media screen and (max-width: 520px){' +
        '.v[data-class=v] .vsys{display:none}}' +
        '.v[data-class=v] .vcards{width:100%}' +
        '.v[data-class=v] .vcards .vcard{padding-top:1.25em;position:relative;display:block}' +
        '.v[data-class=v] .vcards .vcard:after{content:"";clear:both;display:block}' +
        '.v[data-class=v] .vcards .vcard .vimg{width:3.125em;height:3.125em;float:left;border-radius:50%;margin-right:.7525em;' +
        'border:1px solid #f5f5f5;' +
        'padding:.125em}' +
        '@media screen and (max-width: 720px){.v[data-class=v] ' +
        '.vcards .vcard .vimg{width:2.5em;height:2.5em}}' +
        '.v[data-class=v] .vcards .vcard .vhead{line-height:1.5;margin-top:0}' +
        '.v[data-class=v] .vcards .vcard .vhead .vnick{position:relative;font-size:.875em;font-weight:500;margin-right:.875em;cursor:pointer;text-decoration:none;display:inline-block}' +
        '.v[data-class=v] .vcards .vcard .vhead .vnick:hover{color:#d7191a}' +
        '' +
        ...
        '.v[data-class=v] .vcards .vcard .vh .vtime{font-size:.75em;margin-right:.875em}' +
        '.v[data-class=v] .vcards .vcard .vh .vmeta{line-height:1;position:relative}' +
        '.v[data-class=v] .vcards .vcard .vh .vmeta .vat{font-size:.8125em;color:#ef2f11;cursor:pointer;float:right}' +
        '.v[data-class=v] .vcards .vcard:last-child .vh{border-bottom:none}' +
        ...
        'cursor:pointer;max-height:8em;overflow:hidden}' +
